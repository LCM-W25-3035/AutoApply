...
input_filepath = os.path.join("src", "resumes", "data-scientist-resume-example.pdf")  
output_filepath = os.path.join("src", "ai_agents", "all_agents_v2", "extractor_output.json")  

# Reference
# (OpenAI, ChatGPT o1, first prompt, 2025): Please dvivide de customization agent code in two codes, one with the configuration and the second to run the process
# (OpenAI, ChatGPT o1, last prompt, 2025): Improve the code to handling errors in a better way

import asyncio
import json
import os
from customization_agent_V3 import customize_cv
...
output_json_filepath = os.path.join("src", "ai_agents", "customization_agent", "Llama","customized_cv_output.json")
